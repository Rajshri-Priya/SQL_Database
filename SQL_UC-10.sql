...
SELECT MAX(Salary) as Maximum FROM employee_payroll WHERE Gender='M' GROUP BY Gender;

SELECT AVG(Salary) as Average FROM employee_payroll WHERE Gender='F' GROUP BY Gender;
SELECT MIN(Salary) as Minimum FROM employee_payroll WHERE Gender='F' GROUP BY Gender;
SELECT MAX(Salary) as Maximum FROM employee_payroll WHERE Gender='F' GROUP BY Gender;
...
INSERT INTO employee_payroll VALUES('Priya','25000','26-aug-2019','F','9256345628','pune',DEFAULT);
INSERT INTO employee_payroll VALUES('Sumit','25000','5-feb-2019','M','9833678538',DEFAULT,DEFAULT);
...
UPDATE employee_payroll SET Phone_Number='9874888670',Emp_DEPT=' Hacker', Emp_Address = 'Hyderabad', Basic_Pay=12000,Deduction=5000,Taxable_Pay=2300,Income_Tax = 2564,Net_Pay=18000 WHERE Name='Raj';
UPDATE employee_payroll SET Phone_Number='9874117670',Emp_DEPT='Head', Emp_Address = 'Chennai', Basic_Pay=12000,Deduction=5000,Taxable_Pay=2300,Income_Tax = 2564,Net_Pay=10000 WHERE Name='Shri';
UPDATE employee_payroll SET Phone_Number='9874227670',Emp_DEPT='Developer', Emp_Address = 'Pune', Basic_Pay=22000,Deduction=16000,Taxable_Pay=5300,Income_Tax = 5564,Net_Pay=22000 WHERE Name='Sachin';
UPDATE employee_payroll SET Phone_Number='9874887670',Emp_DEPT='Developer', Emp_Address = 'Mumbai', Basic_Pay=13000,Deduction=5450,Taxable_Pay=2500,Income_Tax = 2564,Net_Pay=10000 WHERE Name='Nikita';
...
UPDATE employee_payroll SET Phone_Number='9833678738',Emp_DEPT='Purchasing', Emp_Address = DEFAULT, Basic_Pay=16000,Deduction=5660,Taxable_Pay=2800,Income_Tax = 5564,Net_Pay=14000 WHERE Name='Priya';
UPDATE employee_payroll SET Phone_Number='9833678538',Emp_DEPT='Resource', Emp_Address = 'Bengaluru', Basic_Pay=18000,Deduction=5440,Taxable_Pay=4400,Income_Tax = 4764,Net_Pay=16000 WHERE Name='Sumit';

----------------------------------
INSERT INTO employee_payroll VALUES('Soniya','48548','20-jan-2020','F','8758989','Nainital','Sales','54767',4875,4555,54767,376734);
select * from employee_payroll where Name='Soniya';
SELECT * FROM EMPLOYEE_PAYROLL;

--delete row
delete from EMPLOYEE_PAYROLL where NAME='Shri';